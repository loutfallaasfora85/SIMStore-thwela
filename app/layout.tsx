...
export const metadata: Metadata = {
  ...
  title: {
    default: "برج المبدع للأجهزة المنزلية | أفضل الأجهزة بأعلى جودة وأفضل سعر",
    template: "%s | برج المبدع للأجهزة المنزلية",
  },
  description:
    "برج المبدع للأجهزة المنزلية - وجهتكم الأولى لأحدث الأجهزة الإلكترونية والتقنيات المنزلية والمكتبية. نوفر لكم أحدث الابتكارات التقنية من أرقى الماركات العالمية بأفضل الأسعار مع ضمان الجودة.",
  keywords: [
    "برج المبدع",
